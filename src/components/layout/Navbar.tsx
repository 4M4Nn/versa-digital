      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3.5 md:px-8">
          ...
          <button
            ...
            className={cn(
              "flex size-10 items-center justify-center rounded-full border md:hidden",
              ...
              {navLinks.map((link, i) => (
                ...
                >
                  <Link
                    href={link.href}
                    onClick={() => setOpen(false)}
                    className="py-2.5 font-heading text-3xl font-bold text-text-dark transition-colors hover:text-violet"
                  >
                    {link.label}
                  </Link>
                </motion.div>
